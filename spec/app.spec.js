...
describe('/', () => {
  ...
  describe('/articles', () => {
    ...
    it.only('POST status:201, adds new article', () => {
      const articlesToAdd = {
        title: 'test',
        body: 'this is a test',
        votes: 5,
    ...
    it('QUERY takes a query of topic', () => request
      ...
      .expect(200)
      .then((res) => {
        expect(res.body.filtered).to.have.length(9);
      }));
    it('Query take both topic and author', () => request
    ...
    it('Query sorts by author', () => request
    ...
    describe('/article_id', () => {
      ...
      it('DELETE status:204, deletes article by its id', () => request
  ...
  describe('error handling', () => {
    ...
    describe('/api/articles', () => {
      ...
      describe('/:article_id', () => {
        ...
        describe('/comments', () => {
          it('GET status:404, when non existent article id', () => request
          ...
          it('GET status:404, when invalid article id', () => request
  ...
  describe('nc tests', () => {
    it('status:405 invalid request method for end-point', () => request
      .delete('/api/articles')
      .expect(405)
      .then((res) => {
